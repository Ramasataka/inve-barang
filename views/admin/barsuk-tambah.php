                        ...
                        <br>
                            ...
                            <form action="barsuk-tambah.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <select name="barang" class="js-example-basic-single form-select text-bg-dark " title="Select the barangr" id="barang" >  
                                        <?php
                                            if($getbarang){
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control text-bg-dark" type="number" name="jumlah">
                                </div>
                                <br>
